...
export const NAV_GROUPS_BY_ROLE: Record<Role, NavGroup[]> = {
  [Role.HQ_ADMIN]: [
    ...
    {
      key: "inbound",
      i18nKey: "nav.group.inbound",
      items: [
        {
          key: "inbound-import",
          i18nKey: "nav.inboundImport",
          path: "/inbound/import",
        },
        {
          key: "inbound-orders",
          i18nKey: "nav.inboundOrders",
          path: "/inbound/orders",
        },
        {
          key: "inbound-scan",
          i18nKey: "nav.inboundScan",
          path: "/inbound/scan",
        },
      ],
    },
    {
      key: "outbound",
      i18nKey: "nav.group.outbound",
      items: [
        {
          key: "outbound-import",
          i18nKey: "nav.outboundImport",
          path: "/outbound/import",
        },
        {
          key: "outbound-orders",
          i18nKey: "nav.outboundOrders",
          path: "/outbound/orders",
        },
        {
          key: "outbound-plan",
          i18nKey: "nav.outboundPlan",
          path: "/outbound/plan",
        },
        {
          key: "outbound-departure",
          i18nKey: "nav.outboundDeparture",
    ...
    {
      key: "delivery",
      i18nKey: "nav.group.delivery",
      items: [
        {
          key: "delivery-sign",
          i18nKey: "nav.deliverySign",
          path: "/delivery/sign",
        },
      ],
    },
    {
      key: "planning",
      i18nKey: "nav.group.planning",
      items: [{ key: "waybills", i18nKey: "nav.waybills", path: "/waybills" }],
    },
    {
      key: "yardOps",
      i18nKey: "nav.group.yardOps",
      items: [
        { key: "yard-board", i18nKey: "nav.yardBoard", path: "/yards" },
        {
          key: "yard-batch-assign",
          i18nKey: "nav.yardBatchAssign",
          path: "/yards/batch-assign",
        },
        {
          key: "vin-inventory",
          i18nKey: "nav.vinInventory",
          path: "/vin-inventory",
        },
      ],
    },
    {
      ...
      items: [{ key: "tracking", i18nKey: "nav.tracking", path: "/tracking" }],
    },
    {
      key: "finance",
    ...
    },
    {
      ...
      items: [
        ...
        {
          key: "setup-slots",
          i18nKey: "nav.setupSlots",
          path: "/settings/slots",
        },
        {
          key: "app-releases",
          i18nKey: "nav.appReleases",
          path: "/settings/app-releases",
        },
  ...
  [Role.CARRIER_STAFF]: [
    {
      key: "pickup",
      i18nKey: "nav.group.pickup",
      items: [{ key: "pickup", i18nKey: "nav.pickup", path: "/pickup" }],
    },
    {
      key: "delivery",
      i18nKey: "nav.group.delivery",
    ...
    },
    {
      ...
      items: [
        {
          key: "my-carrier-users",
          i18nKey: "nav.myCarrierUsers",
          path: "/my-carrier/users",
        },
        {
          key: "my-carrier-fleet",
          i18nKey: "nav.myCarrierFleet",
          path: "/my-carrier/fleet",
        },
      ],
    },
  ],
